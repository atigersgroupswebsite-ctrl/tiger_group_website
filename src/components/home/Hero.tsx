      ...
      <Container size="xl">
        <div className="hero-grid">
          ...
          <div className="hero-content">
            ...
            >
              TIGER GROUPS is a diversified enterprise ecosystem delivering trusted career placement, industrial workforce contracting, infrastructure properties, and retail ventures across Central India.
            </motion.p>
