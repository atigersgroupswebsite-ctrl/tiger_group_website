            ...
            <ScrollReveal direction="right">
              <div>
                ...
                <p style={{ fontSize: 'var(--text-lg)', lineHeight: 1.65, color: 'var(--color-midnight-navy)', fontWeight: 500, marginBottom: 'var(--space-6)' }}>
                  TIGER GROUPS operates a multi-industry ecosystem across Central India, anchored by our flagship recruitment vertical — A Tiger Global Career Solution & Consultancy.
                </p>
