        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div style={{ marginTop: 'var(--space-3)' }}>
              <a
                href="https://wa.me/918349353946"
                target="_blank"
                rel="noopener noreferrer"
                className="btn btn-outline-light btn-sm"
                aria-label="Direct WhatsApp chat with A Tiger Group at +91 8349353946"
                style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '0.45rem',
                  ...
                  border: '1px solid rgba(252, 251, 251, 0.35)',
                  maxWidth: '100%',
                }}
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                  fill="currentColor"
                  style={{ color: 'var(--color-champagne)', flexShrink: 0 }}
                  aria-hidden="true"
                >
